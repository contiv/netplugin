...
import (
	...
	"github.com/contiv/client-go/pkg/apis/authentication"
	"github.com/contiv/client-go/pkg/apis/authentication/v1beta1"
...
func init() {
	if err := announced.NewGroupMetaFactory(
		&announced.GroupMetaFactoryArgs{
			...
			ImportPrefix:               "github.com/contiv/client-go/pkg/apis/authentication",
